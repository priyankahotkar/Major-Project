...
import { MessageSquare, Video, LogOut, PlusCircle } from 'lucide-react';
...
export function MentorDashboardPage() {
      ...
      try {
        ...
        const menteesList = snapshot.docs.map((doc) => {
          ...
          return {
            ...
            avatar: data.menteePhotoURL || "https://via.placeholder.com/100",
            domain: data.menteeDomain || "Not Specified",
          };
        });
  ...
  const updateTimeSlots = async () => {
    ...
    try {
      const userRef = doc(db, "users", user.uid);
      await setDoc(userRef, { availableTimeSlots: timeSlots }, { merge: true });
